...
type Skill = { capability :: cap.Capability, handle :: (msg.Message) -> [io, time, crypto, random, sql, fs_read, fs_write, net, concurrent, llm, proc, approval] HandlerOutcome }
...
fn dispatch_request(agent :: AgentDef, body :: Str) -> [io, time, crypto, random, sql, fs_read, fs_write, net, concurrent, llm, proc, approval] Str {
...
fn handle_method(agent :: AgentDef, req :: proto.Request) -> [io, time, crypto, random, sql, fs_read, fs_write, net, concurrent, llm, proc, approval] proto.Response {
...
fn handle_tasks_send(agent :: AgentDef, req :: proto.Request) -> [io, time, crypto, random, sql, fs_read, fs_write, net, concurrent, llm, proc, approval] proto.Response {
...
fn dispatch_skill(agent :: AgentDef, rpc_id :: proto.RpcId, task_id :: Str, ctx_id :: Str, m :: msg.Message, skill_name :: Str) -> [io, time, crypto, random, sql, fs_read, fs_write, net, concurrent, llm, proc, approval] proto.Response {
...
fn run_skill(skill :: Skill, store_ref :: Option[store.Store], trail_log :: Option[trail.Log], rpc_id :: proto.RpcId, task_id :: Str, ctx_id :: Str, m :: msg.Message) -> [io, time, crypto, random, sql, fs_read, fs_write, net, concurrent, llm, proc, approval] proto.Response {
...
fn handle_tasks_get(agent :: AgentDef, req :: proto.Request) -> [io, time, crypto, random, sql, fs_read, fs_write, net, concurrent, llm, proc, approval] proto.Response {
...
fn handle_tasks_cancel(agent :: AgentDef, req :: proto.Request) -> [io, time, crypto, random, sql, fs_read, fs_write, net, concurrent, llm, proc, approval] proto.Response {
  match required_str(req.params, "id") {
    Err(e) => proto.fail(req.id, proto.err_invalid_params(), e),
    Ok(id) => match agent.store {
...
fn dispatch_subscribe_str(agent :: AgentDef, body :: Str) -> [io, time, crypto, random, sql, fs_read, fs_write, net, concurrent, llm, proc, approval] Str {
  list.fold(dispatch_sse_frames(agent, body), "", fn (acc :: Str, frame :: Str) -> Str {
    str.concat(acc, frame)
  })
}

fn dispatch_sse_frames(agent :: AgentDef, body :: Str) -> [io, time, crypto, random, sql, fs_read, fs_write, net, concurrent, llm, proc, approval] List[Str] {
  match proto.parse_request(body) {
...
fn build_subscribe_frames(agent :: AgentDef, req :: proto.Request) -> [io, time, crypto, random, sql, fs_read, fs_write, net, concurrent, llm, proc, approval] List[Str] {
  let params := req.params
  match required_str(params, "id") {
...
fn run_skill_subscribe(agent :: AgentDef, rpc_id :: proto.RpcId, task_id :: Str, ctx_id :: Str, m :: msg.Message, skill_name :: Str) -> [io, time, crypto, random, sql, fs_read, fs_write, net, concurrent, llm, proc, approval] List[Str] {
  let resolved := if str.is_empty(skill_name) {
    match list.head(agent.skills) {
      Some(s) => Some(s),
      None => None,
...
fn emit_skill_frames(skill :: Skill, store_ref :: Option[store.Store], trail_log :: Option[trail.Log], rpc_id :: proto.RpcId, task_id :: Str, ctx_id :: Str, m :: msg.Message) -> [io, time, crypto, random, sql, fs_read, fs_write, net, concurrent, llm, proc, approval] List[Str] {
  let bindings := [("args", bindings_from_message(m))]
  match cap.gate(skill.capability, bindings) {
    Deny(_) => {
